                    ...
                    return (
                        <div key={index} className="mt-8 flex justify-between items-center">
                            ...
                            <div className="flex gap-4">
                                ...
                                <button type="button" disabled={!asAudio(data)}  onClick={()=>handleClick(data)} className="aspect-square rounded-full bg-green-400 text-white p-2 cursor-pointer hover:bg-green-600 transition-all disabled:pointer-events-none disabled:bg-gray-400">
